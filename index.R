...
if(controls$run_analysis_shs){
  ...
  rmarkdown::render("1_stakeholder_survey_description.R", output_dir=controls$savepoint, clean=FALSE)
...
if(controls$run_analysis_brs){
  rmarkdown::render("1_BeReady_survey_description.R", output_dir=controls$savepoint, clean=FALSE)
