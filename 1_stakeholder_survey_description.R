...
#' Safety and Veterinary Office (FSVO), focuses on the impacts of heat, 
#' mycotoxins, and vector-borne diseases on both animal and human health.
#' 
...
#' respondents within relevant cantonal and Liechtenstein services, based on their role and 
...
#'   Participants reported using a wide range of channels to disseminate information, most commonly official websites, emails, flyers, 
...
#'   knowledge gaps were in disease and vector management and control (36%), as well as prevention (22%) and detection (20%). Several 
#'   respondents pointed to uncertainties around the appropriate use of adulticides, sharing of responsibilities among stakeholders, and 
#'   long-term control strategies. Regarding actual control measures against mosquitoes, over half of participants (53%) reported 
#'   that no active mosquito control measures are in place. Among those that did report activities, biological larvicides (25%) and 
#'   elimination of breeding sites (20%) were the most common, while use of adulticides (11%) and non-chemical larvicides (7%) was less frequent. 
#'   Open-text answers revealed a mix of pilot studies, public awareness campaigns, and experimental approaches like sterile insect techniques (SIT),
#'    often in collaboration with academic or federal partners. Some respondents indicated that control responsibilities lie with other agencies,
...
#'  for outbreak preparedness, surveillance, and the responsible use of control tools like biocides or adulticides. Several participants emphasized
#'   the importance of financial and human resource support, centralized information platforms, and a coordinated national monitoring strategy.
#'    Others cited challenges related to fragmented responsibilities across levels of government or lack of expertise and capacity. 
#'    When asked about the integration of tick- and mosquito-borne disease issues into national and cantonal climate adaptation strategies,
...
#' # Conclusion
#' 
#' This national survey provides a first detailed overview of how cantonal authorities in Switzerland and 
#' Liechtenstein are engaged in the monitoring, prevention, and control of diseases transmitted by ticks and mosquitoes. 
#' While most respondents (77%) reported some level of involvement in related activities, findings reveal notable disparities in resources, 
#' actions, and strategic alignment across cantons and sectors.
#' 
#' Efforts appear more advanced for mosquito-borne diseases, with a broader range of implemented activities such as 
#' public awareness campaigns, professional training, and both active and passive monitoring. In contrast, tick-related 
#' activities were reported far less frequently, with more than half of respondents stating that their authority does not
#'  currently engage in any tick-related measures. Access to dedicated human or financial resources remains limited overall,
#'   particularly for tick-borne disease interventions.
#' 
#' The survey highlights important knowledge gaps reported by cantonal authorities, 
#' particularly in the areas of disease management and pathogen detection. These gaps 
#' were reported more frequently for mosquito-borne than tick-borne diseases, reflecting 
#' the growing public health importance of invasive mosquito species. Despite these challenges, 
#' several authorities reported innovative or pilot measures, such as the use of biological larvicides
#'  and participation in sterile insect technique studies. 
#' 
#' Collaborative networks are more commonly established around mosquito-related issues,
#'  with 60% of respondents indicating active exchanges with researchers and specialists
#'   in that domain, compared to only 20% for tick-related issues. Many participants called
#'    for stronger coordination across cantons, improved knowledge transfer, and clearer federal leadership,
#'     especially regarding outbreak preparedness, standardized intervention strategies, and resource sharing.
#' 
#' Finally, the survey underscores a general lack of integration of vector-borne diseases 
#' into climate adaptation strategies, both at the national and cantonal levels. Most respondents 
#' were unaware of whether these health issues are considered in existing climate strategies, suggesting 
#' a need to strengthen the connection between climate and vector-borne disease planning. Together, 
#' these findings point to the importance of reinforcing institutional capacity, inter-cantonal collaboration, 
#' and federal support in order to build a more coherent and effective response to the rising threat of vector-borne 
#' diseases under changing climatic conditions.